...
#pragma HLS INTERFACE m_axi port=conv_mp_3_weights bundle=gmem2 depth=CONV3_SIZE * CONV3_SIZE * CONV3_FILTER * CONV3_IN_CHANNEL
#pragma HLS INTERFACE m_axi port=conv_4_weights bundle=gmem3 depth=CONV4_SIZE * CONV4_SIZE * CONV4_FILTER * CONV4_IN_CHANNEL
#pragma HLS INTERFACE m_axi port=dense_1_weights bundle=gmem4 depth=FC1_DENSE_SIZE * CONV4_OUT_SIZE * CONV4_OUT_SIZE * CONV4_FILTER
#pragma HLS INTERFACE m_axi port=output1 offset=slave bundle=gmem5 depth = FC2_1_DENSE_SIZE
#pragma HLS INTERFACE m_axi port=output2 offset=slave bundle=gmem6 depth = FC2_2_DENSE_SIZE
#pragma HLS INTERFACE m_axi port=output3 offset=slave bundle=gmem7 depth = FC2_3_DENSE_SIZE
